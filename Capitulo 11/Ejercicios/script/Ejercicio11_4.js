...
function redondearAEntero(numero){
    resultados.innerHTML = "<br>Entero >>> " + (Math.floor(numero));
}

function redondearADecimas(numero){
    resultados.innerHTML += "<br>Decimas >>> " + (Math.floor(numero * 10 + .5) / 10);
}

function redondearACentesimas(numero){
    resultados.innerHTML += "<br>Centesimas >>> " + (Math.floor(numero * 100 + .5) / 100);
}

function redondearAMilesimas(numero){
    resultados.innerHTML += "<br>Milesimas >>> " + (Math.floor(numero * 1000 + .5) / 1000);
}
